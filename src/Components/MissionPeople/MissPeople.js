        ...
        <div className={`container ${classes.mission}`} id='workers'>
            ...
            <div className={`row ${classes.row}`}>
                <div className={`col-sm-3 ${classes.coll}`}>
                    ...
                    <p className={classes.pp}>Founder</p>
                    <h3 className={classes.hh3}>+323-923-4683</h3>
                </div>
                <div className={`col-sm-3  ${classes.coll}`}>
                ...
                <div className={`col-sm-3  ${classes.coll}`}>
                    ...
                    <h3 className={classes.hh3}>+323-933-4788</h3>
                </div>
                <div className={`col-sm-3  ${classes.coll}`}>
                    ...
                    <h3 className={classes.hh3}>+323-943-4698</h3>
                </div>
            </div>
            </Slide>
        </div>
